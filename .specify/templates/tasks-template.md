...
**Tests**: Tests are REQUIRED for behavior changes. Include the lowest effective
test level for each changed behavior, plus integration, contract, or end-to-end
coverage when behavior spans modules, persistence, APIs, or UI flows. If a test
is intentionally skipped, include a validation task with the documented
justification from plan.md.
...
<!--
  ...
  - Constitution gates from plan.md for code quality, testing, UX consistency,
...
- [ ] T004 [P] Configure test runner and coverage or reporting commands
...
- [ ] T011 Establish shared UX state patterns for validation, loading, empty, and errors
...
- [ ] T014 [P] [US1] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T019 [US1] Add validation, loading, empty, and error states consistent with existing UX
- [ ] T020 [US1] Add logging for user story 1 operations
- [ ] T021 [US1] Validate performance expectation from plan.md for user story 1
...
- [ ] T024 [P] [US2] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T029 [US2] Validate UX consistency and performance expectation from plan.md
...
- [ ] T032 [P] [US3] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T036 [US3] Validate UX consistency and performance expectation from plan.md
...
- [ ] TXXX Run linting, formatting, typing, and static checks
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Run performance validation documented in plan.md
- [ ] TXXX Verify UX consistency for affected flows and states
...
- UX and performance validation before story checkpoint
...
Task: "Unit test for [component/service] in tests/unit/test_[name].py"
